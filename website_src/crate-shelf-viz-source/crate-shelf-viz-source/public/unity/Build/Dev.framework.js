...
var ASM_CONSTS = {
  4377736: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4377791: ($0) => { performance.now = function() { return $0; }; },  
 4377839: ($0) => { performance.now = function() { return $0; }; },  
 4377887: () => { performance.now = Module['emscripten_get_now_backup']; }
};
